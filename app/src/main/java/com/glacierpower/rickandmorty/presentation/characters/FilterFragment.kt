...
import com.glacierpower.rickandmorty.databinding.FragmentFilterBinding
...
class FilterFragment : BottomSheetDialogFragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        var gender: String = getString(R.string.emty_line)
        var status: String = getString(R.string.emty_line)
        var name: String = getString(R.string.emty_line)
        ...
        viewBinding.clear.setOnClickListener {
            ...
            gender = getString(R.string.emty_line)
            status = getString(R.string.emty_line)
        }
